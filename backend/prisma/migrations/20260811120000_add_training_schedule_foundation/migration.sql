...
--
-- The baseline migration already creates these schedule tables on fresh/test
-- databases. This migration therefore MUST also be safe when the objects are
-- already present, which is the state observed in the failing CI database.
