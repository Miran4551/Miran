...
export const TRAINING_REQUEST_TRANSITIONS: TransitionTable = {
  ...
  // A returned request may resume the normal cluster review path, or — when its
  // existing hospital/department/trainer allocation and active rotation were
  // deliberately preserved — the cluster may finalize the already-completed
  // approvals without forcing a new allocation or replaying hospital approvals.
  resubmitted: ['under_cluster_review', 'active'],
  rejected: [],
