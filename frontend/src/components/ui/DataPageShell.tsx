...
import { InactiveTrainingRequestsPanel } from '../training/InactiveTrainingRequestsPanel';
...
export const DataPageShell: React.FC<{
  ...
  const showInactiveRequestManagement = window.location.pathname === '/affiliations';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: space.xl, width: '100%' }}>
      ...
      {showInactiveRequestManagement && <InactiveTrainingRequestsPanel />}
